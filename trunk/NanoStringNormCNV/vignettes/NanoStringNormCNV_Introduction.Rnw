...
\begin{center}
	\includegraphics[width=0.7\textwidth]{positive-control-correlations_zoomed-in.png}  
...
\begin{center}
	\includegraphics[width=0.9\textwidth]{restriction-fragmentation-ratios_multiplot.png}
...
\begin{center}
	\includegraphics[width=0.7\textwidth]{all-invariant-probe-counts_scatterplot.png}  
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{raw-logged_counts-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{normalized-logged_counts-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{raw-count_inter-sample-correlation-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{norm-count_inter-sample-correlation-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{raw-cna-calls_cna-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{rounded-cna-calls_cna-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{replicate_raw-logged_counts-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{replicate_norm-logged_counts-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{replicate_norm-count_inter-sample-correlation-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{replicate_tumour-only_norm-count_inter-sample-correlation-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{replicate_cna-calls_cna-heatmap.png}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{replicate_cna-concordance_counts-heatmap.png}
